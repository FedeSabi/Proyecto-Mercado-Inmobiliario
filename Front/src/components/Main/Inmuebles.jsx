...
<div>
      <div className='flex justify-center items-center h-[30vh]'>
        <h1>Solicitud de Inmuebles</h1>
      </div>


      <div className=" h-[50vh] flex justify-center items-center">
        <div className="mr-4 block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          <div className="p-6">
