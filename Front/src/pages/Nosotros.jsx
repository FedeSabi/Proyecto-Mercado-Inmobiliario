        ...
        <div className="relative mt-28">
          <div className="lg:max-w-xl lg:pr-5 relative z-40">
            ...
            <p className="text-base text-gray-700">
              Somos una empresa joven que soluciona a nuestros clientes la
              busqueda de propiedades para Inmobiliarias, constructoras y
              usuarios particulares
            </p>
            <div className="mt-10 flex flex-col items-center md:flex-row">
              <a
                href="/"
                className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-orange-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-orange-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
              >
                Ver Mas
              </a>
              <a
