    ...
    <div className="bg-white relative flex items-center justify-center overflow-hidden z-50">
        ...
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
          <div className="relative">
            <div className="lg:max-w-xl lg:pr-5 relative z-40">
              <p className="flex text-sm uppercase text-g1">Sobre Nosotros</p>
              <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                Hacemos que tu busqueda sea 
                <span className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">diferente</span>
              </h2>
              <p className="text-base text-gray-700">Somos una empresa joven que soluciona a nuestros clientes la busqueda de propiedades para Inmobiliarias, constructoras y usuarios particulares</p>
              <div className="mt-10 flex flex-col items-center md:flex-row">
                <a href="/" className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-orange-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-orange-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                  Ver Mas
                </a>
                <a href="/" aria-label="" className="group inline-flex items-center font-semibold text-g1">Mira nuestras propiedades
          ...
          <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
            ...
            <div className="bg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
              <img src={ImgNosotros} alt="placeholder" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute top-10 left-3/4 z-0 opacity-10">
        <svg fill="#000000" width="800px" height="800px" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" className="w-96 z-0 h-full object-fill fill-blue-300 text-blue-300">
          <path d="M230.704 99.2a4.004 4.004 0 0 0-4.01-3.995h-50.981c-2.215 0-5.212-1.327-6." />
        </svg>
      </div>
    </div>
