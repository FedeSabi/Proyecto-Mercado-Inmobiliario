...
const [actualizarNombre_completo, setActualizarNombre_completo] = useState("")
...
try{
    ...
    await axios.put(`http://localhost:4000/corredor/${id}`, updateCorredor) // poner direccion de back para modificar la BD
  ...
  return (
    ...
    {mostrarFormulario && (
        ...
        {!mostrarFormulario && idCorredorActualizar && (
          ...
          <h2 className="mb-[26px] flex h-[40px] w-[150px] items-center justify-center rounded-lg bg-orange-500 text-white">Modificar Corredor</h2>
          <form onSubmit={(e) =>{
            e.preventDefault()
...
const AdmCorredor = () => {
    ...
    const handleUpdateClick = async (id) => {
        ...
        try {
            ...
            await axios.put(`http://localhost:4000/corredor/${idCorredorActualizar}`, updateCorredor);
            ...
            {!mostrarFormulario && idCorredorActualizar && (
                <div className="flex-col p-4 justify-center">
                    ...
                    <form onSubmit={(e) => {
                        ...
                        <input className="h-7 w-1/5 rounded-lg border border-solid border-orange-500 focus:outline-none"
                            type="text"
                            value={actualizarNombre_completo}
                            onChange={(e) => setActualizarNombre_completo(e.target.value)}
                        />
                        <label className="mb-2">Descripcion:</label>
                        <input className="h-7 w-1/5 rounded-lg border border-solid border-orange-500 focus:outline-none"
