      ...
      <div className="flex flex-wrap mr-[10px] justify-center ">
        <div className="flex flex-col  ]">
          <div className="h-[65vh] p-3 relative ">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-0 top-1/2 transform -translate-y-1/2 px-4 py-2 h-[48px] bg-orange-500 focus:outline-none hover:bg-gray-500 hover:shadow-none text-white rounded-full"
            >
              ←
            </button>
            <button
              onClick={nextSlide}
              className="absolute right-0 top-1/2 transform -translate-y-1/2 px-4 py-2 h-[48px] bg-orange-500 focus:outline-none hover:bg-gray-500 hover:shadow-none text-white rounded-full"
            >
              →
            </button>
          </div>
            ...
            {images.map((image, index) => (
              <img
                ...
                className={`w-20 h-20 cursor-pointer rounded-md ${
                  index === currentIndex ? "border-2 border-orange-500" : ""
                }`}
          ...
          <div className="flex flex-col justify-center max-w-lg bg-white p-8 rounded-xl shadow shadow-orange-300 ] h-[80vh] w-[90vw] mr-[8%]">
            <form action="">
              <div className="flex flex-col space-y-5">
                ...
                <div>
                  <div className="hidden xl:flex items-center space-x-5 justify-around">
